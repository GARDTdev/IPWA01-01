//standardcode der einmalig nach dem Laden der Javascript Datei aufgerufen wird
//prüft nach Sprache ob [de] Links nach Rechts, der rest wird Rechts nach Links dargestellt in der Navigation der Header
const lang = document.documentElement.lang;
console.log(lang)
if(lang==="de"){ // wenn Sprache de dann
document.getElementsByClassName("nav1")[0].dir = "ltr"; // wird ltr gesetzt
}else{// für alle anderen Sprachen wird rtl
document.getElementsByClassName("nav1")[0].dir = "rtl"; // wird rtl gesetzt
}
